...
class AtribuicaoPerfil extends Model
{
    ...
    protected function casts(): array { return ['vigente_de' => 'datetime', 'vigente_ate' => 'datetime', 'ativo' => 'boolean']; }
    ...
    public function estaVigente(): bool { return $this->ativo && (! $this->vigente_de || $this->vigente_de->isPast()) && (! $this->vigente_ate || $this->vigente_ate->isFuture()); }
}
